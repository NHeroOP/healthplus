...
export default function HomePage() {
  return (
    <>
          ...
          <div className="grid gap-8 lg:grid-cols-2 lg:gap-12 items-center">
            <div className="space-y-6 lg:space-y-8 text-center lg:text-left">
              <div className="space-y-4">
                <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold tracking-tight text-gray-900 dark:text-gray-100">
                  Your Trusted
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                <Button asChild size="lg" className="bg-blue-600 hover:bg-blue-700 w-full sm:w-auto dark:text-white">
                  <Link href="/products">
                ...
                <Button
                  ...
                  variant="outline"
                  size="lg"
                  className="border-green-600 text-green-600 dark:text-green-400 hover:bg-green-50 bg-transparent w-full sm:w-auto"
                >
      ...
      {/* Features Section */}
      <section className="px-4 py-12 sm:py-16 sm:px-6 lg:px-8 bg-white dark:bg-zinc-900">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow duration-300 dark:bg-black/30 ">
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow duration-300 dark:bg-black/30">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">Always Available</h3>
                <p className="text-gray-600 dark:text-gray-400">
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow duration-300 dark:bg-black/30">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">Expert Care</h3>
                <p className="text-gray-600 dark:text-gray-400">
      ...
      <section className="px-4 py-12 sm:py-16 sm:px-6 lg:px-8 bg-gray-50 dark:bg-zinc-950/50">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-8 sm:mb-12">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-gray-100 mb-4">Visit Our Store</h2>
          ...
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">Phone</h3>
              <p className="text-gray-600 dark:text-gray-400">
                (555) 123-4567
                <br />
