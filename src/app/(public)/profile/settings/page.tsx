  ...
  return (
    <Card className="border-border bg-card">
      <CardHeader>
        ...
        <p className="text-xs sm:text-sm text-muted-foreground">General account preferences</p>
      </CardHeader>
      <CardContent>
        <div className="space-y-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
            <div>
              <h4 className="text-sm sm:text-base font-medium text-card-foreground">Theme</h4>
              <p className="text-xs sm:text-sm text-muted-foreground">Choose your preferred theme</p>
            </div>
            <Button variant="outline" size="sm" onClick={toggleTheme} className="bg-transparent w-full sm:w-auto">
              {theme === "light" ? (
                <>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
            <div>
              <h4 className="text-sm sm:text-base font-medium text-card-foreground">Account Status</h4>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
            <div>
              <h4 className="text-sm sm:text-base font-medium text-red-600">Danger Zone</h4>
